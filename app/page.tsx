    ...
    <div className="min-h-screen bg-[#84d1c1] text-gray-900 antialiased">
      ...
      <main className="px-4 sm:px-6">
        <div className="mx-auto max-w-7xl">
            ...
            <div className="grid lg:grid-cols-2 gap-8 items-center">
              ...
              <div className="text-left py-6 lg:py-12">
                ...
                <p className="mt-4 text-lg text-white/95 leading-relaxed">
                  Lockers inteligentes con control de temperatura que mantienen
                  tu comida <strong>caliente o fría</strong> hasta que la
                  recoges. Planifica tu semana en la app o compra opciones del
                  día – wraps shuco, pupusas veggie, y más opciones frescas y
                  saludables.
                </p>
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              ...
              <div className="order-1 lg:order-2">
                ...
                <div className="space-y-4 text-white/90 text-lg leading-relaxed">
                  <p>
                    <strong className="text-white">Nutrify</strong> es un
                    sistema de <strong>lockers inteligentes</strong> instalados
                    en tu universidad que combinan tecnología IoT, control de
                    temperatura y una app móvil para entregarte comida saludable
                    en menos de 1 minuto.
                  </p>
                  <p>
                    Cada locker mantiene tus kits a la{" "}
                    <strong>temperatura perfecta</strong> (caliente para
                    proteínas, frío para ensaladas) y se abre escaneando un
                    código QR único desde tu teléfono. Sin filas, sin esperas.
                  </p>
                  <p className="bg-white/10 backdrop-blur-sm rounded-lg p-4 border-l-4 border-[#f56914]">
                    💡 <strong>Diferencia clave:</strong> No somos delivery ni
                    cafetería. Somos lockers transparentes donde VES tu comida
                    fresca, eliges en app (planificada o del día), y recoges al
                    instante.
                  </p>
                </div>
              </div>
          ...
          <section
            id="tech"
            className="py-10 sm:py-12 bg-white/5 backdrop-blur-sm rounded-3xl"
          >
            <div className="text-center mb-12">
              ...
              <p className="text-white/80 text-lg max-w-3xl mx-auto">
                La interacción perfecta entre app, locker y comida para una
            ...
            <div className="grid lg:grid-cols-3 gap-8 mb-12">
              ...
              <div className="bg-white rounded-2xl p-8 shadow-xl">
                ...
                <h3 className="text-2xl font-bold mb-4 text-gray-900">
                  La App: Tu Control Central
                </h3>
                <ul className="space-y-3 text-gray-700">
                  <li className="flex items-start gap-2">
                    <span className="text-[#0b6b5c] font-bold">✓</span>
                    <span>
                      <strong>IA Personalizada:</strong> Recomendaciones basadas
                      en tus gustos (alta proteína, sin gluten, baja azúcar)
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-[#0b6b5c] font-bold">✓</span>
                    <span>
                      <strong>Planificación Semanal:</strong> Arma tu menú
                      completo en 5 minutos, edita en tiempo real
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-[#0b6b5c] font-bold">✓</span>
                    <span>
                      <strong>Disponibles del Día:</strong> Ve opciones extras
                      con fotos y compra in-situ
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-[#0b6b5c] font-bold">✓</span>
                    <span>
                      <strong>Pago Seguro:</strong> Tarjeta, Qrenta o
                      transferencia. Escanea QR para pagar y abrir
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-[#0b6b5c] font-bold">✓</span>
                    <span>
                      <strong>Notificaciones Smart:</strong>&quot;Tu kit
                      caliente está listo a las 12pm en locker #4&quot;
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-white rounded-2xl p-8 shadow-xl">
                ...
                <h3 className="text-2xl font-bold mb-4 text-gray-900">
                  El Locker: Entrega Inteligente
                </h3>
                <ul className="space-y-3 text-gray-700">
                  <li className="flex items-start gap-2">
                    <span className="text-[#f56914] font-bold">✓</span>
                    <span>
                      <strong>Transparente:</strong> Puertas de vidrio con LED –
                      ves tu comida y genera antojo
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-[#f56914] font-bold">✓</span>
                    <span>
                      <strong>Control Temperatura:</strong> Sensores IoT
                      mantienen 60°C (caliente) o 4-8°C (frío)
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-[#f56914] font-bold">✓</span>
                    <span>
                      <strong>Apertura con QR:</strong> Escanea con tu cámara –
                      verifica identidad y abre en 2 segundos
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-[#f56914] font-bold">✓</span>
                    <span>
                      <strong>Ajuste Automático:</strong> Calienta 10 min antes
                      si recoges a las 12pm
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-[#f56914] font-bold">✓</span>
                    <span>
                      <strong>Pantalla Táctil:</strong> Compra rápida sin app +
                      puerto USB para cargar teléfono
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-white rounded-2xl p-8 shadow-xl">
                ...
                <h3 className="text-2xl font-bold mb-4 text-gray-900">
                  Los Kits: Sabor + Salud
                </h3>
                <ul className="space-y-3 text-gray-700">
                  <li className="flex items-start gap-2">
                    <span className="text-[#0b6b5c] font-bold">✓</span>
                    <span>
                      <strong>Pre-preparados:</strong> Listos para comer,
                      portátiles en empaques térmicos reutilizables
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-[#0b6b5c] font-bold">✓</span>
                    <span>
                      <strong>Sabores locales y saludables:</strong> Shuco wraps
                      integrales, pupusas veggie, bowls balanceados con arroz
                  ...
                  <li className="flex items-start gap-2">
                    <span className="text-[#0b6b5c] font-bold">✓</span>
                    <span>
                      <strong>Personalización:</strong> Alta proteína, sin
                      gluten, bajo sodio según tu perfil
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-[#0b6b5c] font-bold">✓</span>
                    <span>
                      <strong>Frescura:</strong> Preparados cada mañana en
                      cocina uni (Planta Alimentos UVG)
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-[#0b6b5c] font-bold">✓</span>
                    <span>
                      <strong>Porción Completa:</strong> 300-500 calorías
                      balanceadas por kit
                    </span>
                  </li>
                </ul>
            ...
            <div className="max-w-5xl mx-auto">
              <div className="text-center mb-10">
                ...
                <p className="text-white/80 text-lg">
                  Tan fácil como 1-2-3 — desde elegir hasta comer en menos de 1
                  minuto
                </p>
              </div>
              ...
              <div className="grid gap-6">
                {[
                  ...
                  <div
                    key={s.n}
                    className="flex flex-col md:flex-row items-center gap-6 bg-white rounded-2xl p-6 shadow-lg hover:shadow-2xl transition-all transform hover:-translate-y-1"
                  >
                    <div className="flex-shrink-0">
                      <div className="h-16 w-16 rounded-2xl bg-gradient-to-br from-[#84d1c1] to-[#0b6b5c] text-white grid place-content-center font-bold text-2xl shadow-lg">
                        {s.n}
                      </div>
                    </div>
          ...
          >
              ...
              {[
                ...
                >
                  ...
                  <div className="flex items-center gap-4 text-sm">
                    <span className="font-semibold text-[#0b6b5c]">
                      {kit.cals}
                    </span>
                    <span className="text-gray-500">•</span>
                    <span className="font-semibold text-[#f56914]">
                      {kit.protein}
                    </span>
                  </div>
                </div>
            ...
            <div className="mt-8 text-center">
              <p className="text-white/80 text-sm">
                ✨ Todos los kits incluyen opción de personalización según tus
          ...
          <section id="pricing" className="py-12 sm:py-14">
            <div className="text-center mb-12">
              ...
              <p className="text-white/80 text-lg max-w-3xl mx-auto">
                Más económico que Campero, más rápido que cafetería, más sano
                que ambulantes
              </p>
            </div>
            ...
            <div className="grid lg:grid-cols-3 gap-8 max-w-6xl mx-auto mb-12">
              ...
              <div className="bg-white rounded-3xl p-8 shadow-xl hover:shadow-2xl transition-all transform hover:-translate-y-2">
                <div className="text-center mb-6">
                  ...
                  <div className="flex items-baseline justify-center gap-2">
                    <span className="text-5xl font-extrabold text-[#0b6b5c]">
                      Q150
                    </span>
                ...
                <ul className="space-y-4 mb-8">
                  <li className="flex items-start gap-3">
                    <div className="h-6 w-6 rounded-full bg-[#e6f7f2] flex items-center justify-center flex-shrink-0 mt-0.5">
                      <span className="text-[#0b6b5c] font-bold text-sm">
                        ✓
                      </span>
                    </div>
                    <div>
                      <div className="font-semibold text-gray-900">
                        5 kits saludables/semana
                      </div>
                      <div className="text-sm text-gray-600">
                        Elige cualquier combinación de nuestro menú
                      </div>
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <div className="text-sm text-gray-600">
                        Recomendaciones según tus gustos y metas
                      </div>
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <div className="text-sm text-gray-600">
                        Caliente o frío, perfecto a tu hora
                      </div>
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                  ...
                  <li className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <div className="text-sm text-white/80">
                        5 kits, IA, temperatura, sin filas
                      </div>
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    ...
                    <div>
                      <div className="font-semibold text-white">
                        Descuento 20% automático
                      </div>
                      <div className="text-sm text-white/80">
                        Con 3 o más amigos registrados
                      </div>
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <div className="text-sm text-white/80">
                        Coordina con tu grupo de estudio
                      </div>
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <div className="text-sm text-white/80">
                        Recogen juntos, perfectos para breaks
                      </div>
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <div className="text-sm text-white/80">
                        1 kit gratis por cada 5 amigos
                      </div>
                    </div>
                  </li>
                </ul>
              ...
              <div className="bg-white rounded-3xl p-8 shadow-xl hover:shadow-2xl transition-all transform hover:-translate-y-2">
                <div className="text-center mb-6">
                  ...
                  <div className="flex items-baseline justify-center gap-2">
                    <span className="text-5xl font-extrabold text-[#f56914]">
                      Q35
                    </span>
                ...
                <ul className="space-y-4 mb-8">
                  <li className="flex items-start gap-3">
                    <div className="h-6 w-6 rounded-full bg-[#f56914]/10 flex items-center justify-center flex-shrink-0 mt-0.5">
                      <span className="text-[#f56914] font-bold text-sm">
                        ✓
                      </span>
                    </div>
                    <div>
                      ...
                      <div className="text-sm text-gray-600">
                        Perfecto para probar o uso ocasional
                      </div>
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <div className="text-sm text-gray-600">
                        Ve opciones en app y compra in-situ
                      </div>
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    ...
                    <div>
                      <div className="font-semibold text-gray-900">
                        Pago con QR al instante
                      </div>
                      <div className="text-sm text-gray-600">
                        Escanea, paga y abre en 10 segundos
                      </div>
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    ...
                    <div>
                      <div className="font-semibold text-gray-900">
                        Mismo control temperatura
                      </div>
                      <div className="text-sm text-gray-600">
                        Caliente o frío según el kit
                      </div>
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
            ...
            <div className="bg-white rounded-2xl p-8 shadow-xl mt-20 max-w-4xl mx-auto">
                ...
                <table className="w-full text-left">
                  ...
                  <tbody>
                    <tr className="border-b border-gray-100 bg-[#e6f7f2]">
                      <td className="py-4 px-4 font-bold text-[#0b6b5c]">
                        ✨ Nutrify Grupal
                      </td>
                      <td className="py-4 px-4 text-center font-bold text-[#0b6b5c]">
                        Q24
                      </td>
              ...
              <div className="mt-6 p-4 bg-[#e6f7f2] rounded-lg">
                <p className="text-sm text-gray-700 text-center">
                  <strong>Ahorro semanal con plan grupal:</strong> Hasta
                  Q100/semana vs. Campero + tiempo recuperado para estudiar
                </p>
              </div>
            </div>
          </section>
            ...
            <div className="relative bg-gradient-to-br from-[#0b6b5c] to-[#84d1c1] rounded-3xl p-12 shadow-2xl text-center overflow-hidden">
              ...
              <div className="relative z-10">
                ...
                <p className="text-white/90 text-lg max-w-2xl mx-auto mb-8">
                  Escríbenos y coordinamos un piloto. Llevamos Nutrify Smart
                  Lockers donde estudias o trabajas.
                </p>
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6">
          <div className="flex flex-col items-center gap-6">
            ...
            <p className="text-white/60 text-sm">
              © {new Date().getFullYear()} Nutrify. Todos los derechos
              reservados.
            </p>
          </div>
        </div>
